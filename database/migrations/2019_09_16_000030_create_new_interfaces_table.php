...
class CreateNewInterfacesTable extends Migration {
	...
	public function up()
	{
		Schema::create('new_interfaces', function(Blueprint $table)
		{
			...
			$table->integer('threshhold')->nullable()->default(0);
