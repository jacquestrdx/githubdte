    ...
    <div id="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="page-header">Offline Sip Accounts for {{$topsipservername->sipservername}}</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                                        ...
                                        @if ($sipaccount->status_id ==2)
                                            <tr style="background-color:#d9534f;">
                                                ...
                                                <td>{{$sipaccount->lastonline }}</td>
                                                    {{--<a href="pages/sipaccount/destroy/{{$sipaccount->id}}">--}}
                                                        {{--<button type="button" class="btn btn-primary btn-circle" data-toggle="modal" data-target="#myModal">--}}
                                                        {{--<button type="button" class="btn btn-primary btn-circle" data-toggle="tooltip" data-placement="top" title="Delete Sip">--}}
                                                            {{--<i class="fa fa-times"></i>--}}
                                                        {{--</button>--}}
                                                    {{--</a>--}}
                                                    {{--<a href="sipaccount/addAcknowledge/{{ Auth::user()->id }}/{{$sipaccount->id}}">--}}
                                                        {{--<button type="button" class="btn btn-primary btn-circle" data-toggle="tooltip" data-placement="top" title="Acknowledge Sip">--}}
