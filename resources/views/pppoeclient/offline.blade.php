            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="dataTable_wrapper col-md-12 col-md-offset-0">
                        <table class="table table-striped table-bordered table-hover dataTable no-footer" id="pppoeoffline-datatable" role="grid" aria-describedby="dataTables-example_info">
                        </table>
                    </div>
                </div>
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        $.ajax({
                            url: "/pppoe/offline/ajax",                  //the script to call to get data
                            data: "",                        //you can insert url arguments here to pass to api.php
                                                             //for example "id=5&parent=6"
                            dataType: 'json',                //data format
                            success: function (dataSet)          //on receive of reply
                            {
                                $('#pppoeoffline-datatable').DataTable( {
                                    colReorder: true,
                                    dom: 'Blfrtip',
                                    buttons: [
